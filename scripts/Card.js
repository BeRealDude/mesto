...
class Card {
    ...
    _setEventListeners() {
        ...
        this._element.querySelector('.elements__button-delete').addEventListener('click', () => {
          ...
          this._element.querySelector('.elements__popup-img').addEventListener('click', () => {
            this._openPopupImg();
           });
      ...
      _likeCard() {
        this._element.querySelector('.elements__button-like').classList.toggle('button-like_active');
      }
